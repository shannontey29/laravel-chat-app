                        ...
                        {!message.message_deleted_at ? (
                            isEditing ? (
                                <div className="flex flex-col">
                                    <textarea
                                        className="px-2 py-1 rounded bg-gray-700 text-gray-200 resize-none"
                                        value={editMessage}
                                        onChange={(e) =>
                    ...
                    {!message.message_deleted_at && !isEditing && (
                        <div className="relative">
                            <div className="absolute top-0 bottom-0 left-0 flex flex-row items-center justify-center text-xs text-gray-700 opacity-0 -ml-14 group-hover:opacity-100">
                                <button
                                    className="mr-1"
                                    onClick={() => replyHandleState(message)}
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 100 100"
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            d="M16.862 3.487a2.25 2.25 0 113.182 3.182l-10.5 10.5a2.25 2.25 0 01-.933.586l-4 1a.75.75 0 01-.932-.933l1-4a2.25 2.25 0 01.586-.933l10.5-10.5z"
                                        />
                                    </svg>
                                </button>
